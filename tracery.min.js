...
(function() {
    ...
    n("utilities", [], function() {
        ...
        function n(n) {
            function l(e) {
                if (o !== e) {
                    ...
                    if (!u)
                        tracery.addError("multiple possible expansion symbols in tag!" + n);
                    else {
                        u = !1;
                        var r = t.split(".");
                        a = r[0],
                        f = r.slice(1, r.length)
                    }
                }
                o = e
            }
            var r = [], i = [], s = 0, o = 0, u = !0, a, f;
        ...
        function r(t) {
            function u(e) {
                ...
                i.length > 0 && (o ? r.push(n(i)) : r.push(i)),
                o = !o,
                s = e + 1
            }
            var r = [];
          ...
          , o = i.extend({
            init: function(e, t) {
                ...
                if (t === null || typeof t != "object") {
                    if (!(typeof t == "string" || t instanceof String))
                        throw console.log("Unknown tagNode input: ", t),
            ...
            expand: function() {
                ...
                this.rule.error && (this.error = this.rule.error,
                ...
                this.rule.sections || console.log(this.rule),
                this.expandChildren();
    ...
    n("rule/rule", [], function() {
        var e = function(e) {
            this.raw = e,
            this.sections = tracery.parseRule(e)
        };
        return e.prototype.getParsed = function() {
            return this.sections || (this.sections = tracery.parseRule(raw)),
            this.sections
        }
        ,
        ...
        var t = Object.freeze({
          ...
          , n = function(e) {
            if (e.constructor === Array)
                e = e.slice(0, e.length);
            else if (e.prototype !== n) {
                if (!(typeof e == "string" || e instanceof String))
                    throw console.log(e),
                    "creating ruleset with unknown object type!";
    ...
    n("grammar", ["./modifiers", "./node", "./symbol", "./rule/rule"], function(e, t, n, r) {
        ...
        i.prototype.loadFrom = function(e) {
            var t;
            this.clear(),
            e.symbols !== undefined ? t = e.symbols : t = e;
            var r = Object.keys(t);
            this.symbolNames = [];
        ...
        i.prototype.addOrGetSymbol = function(e) {
            return this.symbols[e] === undefined && (this.symbols[e] = new n(e)),
            this.symbols[e]
        }
        ,
        ...
        i.prototype.applyMod = function(e, t) {
            if (!this.modifiers[e])
                throw console.log(this.modifiers),
                "Unknown mod: " + e;
        ...
        i.prototype.getRule = function(e, t) {
            ...
            if (n === undefined) {
                var i = new r("{{" + e + "}}");
                return i.error = "Missing symbol " + e,
                i
            }
            var s = n.getRule();
            if (s === undefined) {
                var i = new r("[" + e + "]");
                return console.log(i.sections),
    ...
    n("traceryCore", ["./utilities", "./grammar", "./node"], function(e, t, n) {
        var r = {};
        return console.log("in main tracery"),
        $.extend(r, e),
        ...
        r.test = function() {
            ...
            r.testParse("#[#setPronouns#][#setOccupation#][hero:#name#]story#")
        }
        ,
        r
    }),
